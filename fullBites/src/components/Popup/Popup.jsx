                ...
                bg-black/50 z-50 backdrop-blur-sm">
                    ...
                    shadow-md bg-white rounded-md duration-200 w-[300px]'>
                        ...
                        <div className="flex items-center
                            ...
                            <div>
                                <IoCloseOutline className='text-2xl cursor-pointer hover:bg-red-600 rounded-full' 
                        ...
                        <div className='mt-4'>
                            ...
                            w-full rounded-md border border-gray-300 dark:border-gray-500 px-2 py-1 mb-4'
                            />
                            {/* login Button section */}
                            <div>
                                <button className='bg-primary text-white w-full rounded-md
                                py-1 hover:bg-primaryDark duration-200'
                            ...
                            <div className='mt-4'>
                                ...
                                <div className='flex justify-center gap-2 mt-2'>
                                    ...
                                    <FaGoogle className='text-3xl hover:text-red-500 duration-200 cursor-pointer'/>
                                </div>
                            </div>
                        </div>
                    </div>
